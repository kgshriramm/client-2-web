...
const services: Service[] = [
  ...
  { id: 'mrityunjaya', kn: 'ಮೃತ್ಯುಂಜಯ ಶಾಂತಿ', en: 'Mrityunjaya Shanti', te: 'మృత్యుంజయ శాంతి', image: 'https://t4.ftcdn.net/jpg/02/82/22/25/360_F_282222546_qiGzPx9W9BeuZiXJaDr7o3A3AdgisMnY.jpg' },
...
const words = {
  kn: { home: 'ಮುಖಪುಟ', services: 'ಪೂಜೆಗಳು', booking: 'ಕಾಯ್ದಿರಿಸಿ', call: 'ಈಗ ಕರೆ ಮಾಡಿ', hero: 'ಗೋಕರ್ಣದಲ್ಲಿ ಶಾಸ್ತ್ರೋಕ್ತ ಪೂಜೆಗಳು ಮತ್ತು ವೈದಿಕ ಕರ್ಮಕಾಂಡಗಳನ್ನು ಕಾಯ್ದಿರಿಸಿ', sub: 'ರುದ್ರಾಭಿಷೇಕ, ನಾರಾಯಣ ಬಲಿ, ತ್ರಿಪಿಂಡಿ ಶ್ರಾದ್ಧ, ಪಿತೃ ಕಾರ್ಯ ಮತ್ತು ನವಗ್ರಹ ಶಾಂತಿ ಪೂಜೆಗಳಿಗಾಗಿ ನಂಬಿಕೆಯ ಗೋಕರ್ಣ ಪುರೋಹಿತರ ಸೇವೆಯನ್ನು ಪಡೆಯಿರಿ.', offerings: 'ನಮ್ಮ ಪೂಜಾ ಸೇವೆಗಳು', keywordIntro: 'ಗೋಕರ್ಣದಲ್ಲಿ ರುದ್ರಾಭಿಷೇಕ, ನಾರಾಯಣ ಬಲಿ, ತ್ರಿಪಿಂಡಿ ಶ್ರಾದ್ಧ, ಪಿತೃ ಕಾರ್ಯ ಮತ್ತು ಇತರ ವೈದಿಕ ಪೂಜೆಗಳಿಗಾಗಿ ನಂಬಿಕೆಯ ಪುರೋಹಿತರನ್ನು ಸಂಪರ್ಕಿಸಿ.', enquiry: 'ಪೂಜಾ ವಿಚಾರಣೆ ಕಳುಹಿಸಿ', name: 'ನಿಮ್ಮ ಹೆಸರು', mobile: 'ಮೊಬೈಲ್ ಸಂಖ್ಯೆ', place: 'ಸ್ಥಳ / ವಿಳಾಸ', date: 'ಆದ್ಯತೆಯ ದಿನಾಂಕ', devotees: 'ಭಕ್ತರ ಸಂಖ್ಯೆ', notes: 'ಹೆಚ್ಚುವರಿ ವಿವರಗಳು', select: 'ಪೂಜೆ ಆಯ್ಕೆಮಾಡಿ', send: 'ವಾಟ್ಸ್ಆ್ಯಪ್‌ನಲ್ಲಿ ವಿಚಾರಣೆ ಕಳುಹಿಸಿ', formNote: 'ಸಲ್ಲಿಸಿದ ಬಳಿಕ ವಾಟ್ಸ್ಆ್ಯಪ್‌ನಲ್ಲಿ ನಿಮ್ಮ ವಿಚಾರಣೆಯೊಂದಿಗೆ ಸಂದೇಶ ತೆರೆಯುತ್ತದೆ.', about: 'ಗೋಕರ್ಣ ಪುರೋಹಿತ', aboutText: 'ಗೋಕರ್ಣದಲ್ಲಿ ಸಾಂಪ್ರದಾಯಿಕ ವೇದಿಕ ಪೂಜೆ ಮತ್ತು ಕರ್ಮಕಾಂಡಗಳಿಗಾಗಿ ನೇರವಾಗಿ ಪುರೋಹಿತರನ್ನು ಸಂಪರ್ಕಿಸಿ.' },
  en: { home: 'Home', services: 'Poojas', booking: 'Book a Pooja', call: 'Call Now', hero: 'Book traditional poojas and Vedic rituals in Gokarna', sub: 'Trusted Gokarna Purohita for Rudrabhisheka, Narayana Bali, Tripindi Shraddha, Pitru Karya and Navagraha Shanti.', offerings: 'Pooja services offered', keywordIntro: 'Book a trusted Gokarna Purohita for Rudrabhisheka, Narayana Bali, Tripindi Shraddha, Pitru Karya and other Vedic rituals in Gokarna.', enquiry: 'Send a Pooja enquiry', name: 'Your name', mobile: 'Mobile number', place: 'Place / address', date: 'Preferred date', devotees: 'Number of devotees', notes: 'Additional details', select: 'Select a Pooja', send: 'Send enquiry on WhatsApp', formNote: 'Submitting opens WhatsApp with your booking enquiry.', about: 'Gokarna Purohitha', aboutText: 'Contact a Purohitha directly for traditional Vedic poojas and rituals in Gokarna.' },
  te: { home: 'హోమ్', services: 'పూజలు', booking: 'పూజ బుక్ చేయండి', call: 'ఇప్పుడే కాల్ చేయండి', hero: 'గోకర్ణలో సాంప్రదాయ పూజలు మరియు వైదిక కర్మకాండలను బుక్ చేయండి', sub: 'రుద్రాభిషేకం, నారాయణ బలి, త్రిపిండి శ్రాద్ధం, పితృకార్యాలు మరియు నవగ్రహ శాంతి పూజల కోసం విశ్వసనీయ గోకర్ణ పౌరోహిత్య సేవ.', offerings: 'అందుబాటులో ఉన్న పూజలు', keywordIntro: 'గోకర్ణలో రుద్రాభిషేకం, నారాయణ బలి, త్రిపిండి శ్రాద్ధం, పితృకార్యాలు మరియు ఇతర వైదిక పూజల కోసం విశ్వసనీయ పౌరోహిత్యుడిని సంప్రదించండి.', enquiry: 'పూజ విచారణ పంపండి', name: 'మీ పేరు', mobile: 'మొబైల్ నంబర్', place: 'స్థలం / చిరునామా', date: 'అనుకూల తేదీ', devotees: 'భక్తుల సంఖ్య', notes: 'అదనపు వివరాలు', select: 'పూజ ఎంచుకోండి', send: 'వాట్స్ఆప్‌లో విచారణ పంపండి', formNote: 'సమర్పించిన తర్వాత మీ వివరాలతో వాట్స్ఆప్ సందేశం తెరుచుకుంటుంది.', about: 'గోకర్ణ పౌరోహిత్యుడు', aboutText: 'గోకర్ణలో సాంప్రదాయ వేద పూజలు, కర్మకాండల కోసం పౌరోహిత్యుడిని నేరుగా సంప్రదించండి.' }
};
...
export default function Home() {
  ...
  const placeSections = [
    ...
    },
    {
      ...
      paragraphs: {
        ...
        kn: [
          ...
          'ಶತಮಾನಗಳಿಂದ ಈ ದೇವสถานವು ವೈದಿಕ ಸಂಪ್ರದಾಯದ ಪ್ರಮುಖ ಕೇಂದ್ರವಾಗಿದೆ.'
        ],
        te: [
    ...
    },
    {
      ...
      paragraphs: {
        ...
        kn: [
          'ಗೋಕರ್ಣವು ಶಿವಪೂಜೆ ಹಾಗೂ ಪಿತೃಕಾರ್ಯಗಳಿಗೆ ಅತ್ಯಂತ ಪವಿತ್ರ ಕ್ಷೇತ್ರವಾಗಿದೆ. ಇಲ್ಲಿ ಪೂಜೆಗಳನ್ನು ನೆರವೇರಿಸುವುದರಿಂದ ಆಧ್ಯಾತ್ಮಿಕ ಶಾಂತಿ, ಅಡಚಣೆಗಳನ್ನು ನಿವಾರಣೆ, ದೈವ ಅನುಗ್ರಹ ಮತ್ತು departed ancestorsಗೆ ಪ್ರಾರ್ಥನೆ ಎನ್ನುವುದು ನಂಬಿಕೆಯಾಗಿದೆ.'
        ],
        te: [
  ...
  return <main>
    ...
    <section id="poojas" className="section"><p className="eyebrow">GOKARNA POOJA BOOKING</p><h2>{t.offerings}</h2><p className="intro">{offeringsIntro}</p><p className="intro" style={{ marginTop: '0.75rem' }}>{t.keywordIntro}</p><div className="cards">{services.map(service => <article key={service.id}><div style={{ backgroundImage: `url("${service.image}")` }} role="img" aria-label={serviceName(service)} /><h3>{serviceName(service)}</h3><button onClick={() => { setSelected(serviceName(service)); setBookingOpen(true); }}>{t.booking} →</button></article>)}</div><a className="learn-poojas" href={`/poojas?lang=${language}`}>{language === 'kn' ? 'ಪೂಜೆಗಳ ಬಗ್ಗೆ ಇನ್ನಷ್ಟು ತಿಳಿಯಿರಿ' : language === 'te' ? 'పూజల గురించి మరింత తెలుసుకోండి' : 'Know more about Poojas'} →</a><div className="pooja-image-strip" aria-label="Pooja gallery"><img src="/place-images/image1.jpeg" alt="Pooja ritual" width="640" height="480" loading="lazy" /><img src="/place-images/image2.jpeg" alt="Pooja ritual" width="640" height="480" loading="lazy" /><img src="/place-images/image3.jpeg" alt="Pooja ritual" width="640" height="480" loading="lazy" /><img src="/place-images/image4.jpeg" alt="Pooja ritual" width="640" height="480" loading="lazy" /></div></section>
