...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'gokarna pooja',
    'gokarna pitru dosha pooja cost',
    'narayana bali pooja in gokarna',
    'narayana bali pooja in gokarna cost',
    'gokarna pitru dosha pooja',
    'gokarna temple pooja list',
    'pitru dosha pooja in gokarna',
    'gokarna temple pooja details',
    'pitru dosha pooja cost in gokarna',
    'gokarna pooja details',
    'pandit ji',
    'puja',
    'pandit',
